...
const Keyboard = {
  ...
  _createKeys() {
    ...
    const keyLayout = ["1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "backspace", "caps", "q", "w", "e", "r", "t", "y", "u", "i", "o", "p", "[", "]", "shift", "a", "s", "d", "f", "g", "h", "j", "k", "l", ";", "'", "z", "x", "c", "v", "b", "n", "m", ",", ".", "/", "arrow_up", "enter",
    //"opacity",
        ...
        default:
          ...
          keyElement.addEventListener("click", () => {
            ...
            if (this.properties.lang === 'en') {
              ...
              newSymbol = changeRu[key.toLowerCase()] != undefined ? changeRu[key.toLowerCase()] : key.toLowerCase();
            }
...
function audioButton(ver) {
  if (sondOnOff) {
    ...
    if (ver == 1) {
      ...
      snd = Keyboard.properties.lang == 'ru' ? new Audio("./assets/audio/button2.wav") : new Audio("./assets/audio/button.wav");
    }
    //to play the sound:
    snd.play();
